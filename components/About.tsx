  ...
  return (
    <div className="flex flex-col items-center justify-center text-center bg-[#1e293b] p-4 ml-[200px]">
      ...
      <p className="pl-10 text-xl tracking-wider font-inter">
        I am a jr  front end  web developer  student still working on my license degree.
        ...
        GraphQL, Typescript, Tailwind etc. I have an  experienced  in creat webssite with mean stack 
        technonolgie.
      </p>
      <div className="pt-20">
