      ...
      <div className="grid items-center grid-cols-3 gap-4 font-inter">
        <div className="w-[400px] h-[450px] bg-[#1e293b] p-4 rounded-lg flex justify-center items-center text-3xl font-bold">
          <div className="max-w-sm pt-[30px] overflow-hidden rounded shadow-lg">
            <Image
              src="https://res.cloudinary.com/dfkl6bgec/image/upload/v1671038117/tapture_plhnfy.png"
              alt="React-Ecommerce"
              width={480}
              height={200}
            />
        ...
        <div className="w-[400px] h-[450px] bg-[#1e293b] p-4 rounded-lg flex justify-center items-center text-3xl font-bold">
          <div className="max-w-sm pt-[30px] overflow-hidden rounded shadow-lg">
            <Image
              src="https://res.cloudinary.com/dfkl6bgec/image/upload/v1671038246/Capture_web_1-11-2022_19199_localhost_xy7ruj.jpg"
        ...
        <div className="w-[400px] h-[450px] bg-[#1e293b] p-4 rounded-lg flex justify-center items-center text-3xl font-bold">
          <div className="max-w-sm pt-[30px] overflow-hidden rounded shadow-lg">
            <Image
              src="https://res.cloudinary.com/dfkl6bgec/image/upload/v1671057239/283586091_3160944844220627_3417894944885120228_n_ncvvmu.jpg"
              alt="Sunset in the mountains"
              width={480}
              height={200}
            />
            <div className="px-6 py-2">
              <div className="mb-4 text-xl font-bold">
                conspetion of 3D charcer with blender
              </div>
        ...
        <div className="w-[400px] h-[450px] bg-[#1e293b] p-4 rounded-lg flex justify-center items-center text-3xl font-bold">
          <div className="max-w-sm pt-[30px] overflow-hidden rounded shadow-lg">
            <Image
              src="https://res.cloudinary.com/dfkl6bgec/image/upload/v1671058956/3dportfu_nlduqc.png"
              alt="Sunset in the mountains"
              width={480}
              height={200}
            />
            <div className="px-6 py-2">
              <div className="mb-2 text-xl font-bold">
              make 3d portfolio with Next.js | Three.js 
              </div>
              <p className="text-base text-gray-700">
        ...
        <div className="w-[400px] h-[450px] bg-[#1e293b] p-4 rounded-lg flex justify-center items-center text-3xl font-bold">
          <div className="max-w-sm pt-[30px] overflow-hidden rounded shadow-lg">
            <Image
              src="https://res.cloudinary.com/dfkl6bgec/image/upload/v1671058239/top-car_iybplr.png"
              alt="Sunset in the mountains"
              width={480}
              height={200}
            />
